...
<form method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="email" class="form-control" id="registerEmail1" name="email" value="<?=isset($postData) ? $postData['email'] : ""; ?>">
        </div>
        <div class="form-group col-md-6">
            <label for="registerEmail2">Confirm Email</label>
            <input type="email" class="form-control" id="registerEmail2" name="email1" value="<?=isset($postData) ? $postData['email1'] : ""; ?>">
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="password" class="form-control" id="registerPassword1" name="password" value="">
        </div>
        <div class="form-group col-md-6">
            <label for="registerPassword2">Confirm Password</label>
            <input type="password" class="form-control" id="registerPassword2" name="password1" value="">
        </div>
    </div>
